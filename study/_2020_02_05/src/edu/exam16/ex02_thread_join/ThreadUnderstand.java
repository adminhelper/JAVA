package edu.exam16.ex02_thread_join;
 
/*
모든 프로세스에는 반드시 1개이상의 스레드가 존재한다
기본적으로 main메서드를 실행하는 스레드를 "main 스레드"라고 한다
...
public class ThreadUnderstand {
	public static void main(String[] args) {
		...
		System.out.println("홍길동 스레드 부하들 기다림...");
		try {
			st0.join();	// 끝나기를 기다린다
			st1.join();	// 끝나기를 기다린다
		}catch(InterruptedException e) {

...
public class StaticVariable {
	public static void main(String[] args) {
		...
		int total = bitSinchon.getStudentNum() +
					bitRoot.getStudentNum() +
					bitJongro.getStudentNum() +
					bitGangNam.getStudentNum();
		System.out.println("비트캠프 학생 총 인원: " + total);		
	}
}

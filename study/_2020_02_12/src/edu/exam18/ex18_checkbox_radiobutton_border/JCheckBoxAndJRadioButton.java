package edu.exam18.ex18_checkbox_radiobutton_border;
...
public class JCheckBoxAndJRadioButton {
	public static void main(String[] args) {
		...
		// Language 이름으로 그룹영역을 표시하자
		Border rbtnBorder = BorderFactory.createEtchedBorder();
		rbtnBorder = 
				BorderFactory.createTitledBorder(rbtnBorder, 
												"Language");
		JPanel rbtnBorderPanel = new JPanel();
		rbtnBorderPanel.setLayout(new GridLayout(0, 1, 3, 3));
